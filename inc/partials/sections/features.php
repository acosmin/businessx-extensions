 ...
 */
	...
	if( ! function_exists( 'bx_ext_part__features_wrap_start' ) ) {
		function bx_ext_part__features_wrap_start() {
			$parallax = businessx_section_parallax( 'features_bg_parallax', 'features_bg_parallax_img', true );
			?><section id="section-features" class="grid-wrap sec-features"<?php echo $parallax; ?>><?php
		}
	}
